...
"""
IDEA_NS.py - Production Trading Script

Stock: IDEA.NS
Strategy: VOLUME_DIVERGENCE
Win Rate: 59.5% (from benchmark: benchmark)
Parameters: {'obv_lookback': 20, 'price_lookback': 14}
