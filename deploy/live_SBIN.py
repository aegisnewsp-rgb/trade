#!/usr/bin/env python3
"""
Live Trading Script for SBIN.NS
...
STATE_FILE = Path("/home/node/workspace/trade-project/deploy/state_SBIN.json")

def setup_logging():
    LOG_DIR.mkdir(parents=True, exist_ok=True)
    log_file = LOG_DIR / f"live_SBIN_{date.today().isoformat()}.log"
