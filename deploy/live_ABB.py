...
Win Rate: 58.06% -> Target 65%+ (v8 LOWWR: full multi-filter upgrade from ADX_TREND v2)
Position: ₹7000 | Stop Loss: 0.6% | Target: 4.0x ATR | Daily Loss Cap: 0.3%
Enhanced: 2026-03-23 - v8 LOWWR: added MACD + Bollinger Band + Trend MA to ADX_TREND v2
"""
...
def main():
    print(f"\n{'='*60}")
    print(f"Running: ABB.NS | Strategy: VWAP_RSI_MACD_VOL_BB_v8_LOWWR")
    print(f"{'='*60}")
