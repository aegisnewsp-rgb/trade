#!/usr/bin/env python3
"""
Live Trading Script - MAPMYINDIA.NS (C E Info Systems / MapMyIndia)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_MAPMYINDIA.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_MAPMYINDIA")
...
def log_signal(signal: str, price: float, atr: float, rsi: float):
    log_file = LOG_DIR / "signals_MAPMYINDIA.json"
...
def daily_loss_limit_hit() -> bool:
    cap_file = LOG_DIR / "daily_pnl_MAPMYINDIA.json"
