...
Win Rate: 16.7% -> Target 65%+ (v8 LOWWR: full multi-filter upgrade from VWAP basic)
...
def apply_festive_and_tractor_filters(signal: str, festive_status: str,
    ...
    """Apply M&M-specific rural/agriculture filters on top of v8 multi-filter signal"""
    if signal == "HOLD":
        return "HOLD"
...
def main():
    print(f"\n{'='*60}")
    print(f"Running: M&M.NS | Strategy: VWAP_RSI_MACD_VOL_BB_v8_LOWWR")
    print(f"{'='*60}")
