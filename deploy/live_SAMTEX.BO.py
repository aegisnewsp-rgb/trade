#!/usr/bin/env python3
"""
Live Trading Script - SAMTEX.BO.py
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_SAMTEX_BO.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_SAMTEX_BO")

# ── Config ────────────────────────────────────────────────────────────────────
SYMBOL         = "SAMTEX.BO"
STRATEGY = "MEAN_REVERSION_RSI_V9"  # SAMTEX.py
TARGET_1_MULT = 1.5
TARGET_2_MULT = 3.0
TARGET_3_MULT = 5.0
STOP_LOSS_PCT  = 0.006
