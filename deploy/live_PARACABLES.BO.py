...
Win Rate: PARACABLES.BO (low base) -> Target 55%+ (v8 multi-filter upgrade) 60%+ (v8: Added MACD, volume, trend, BB filters to tighten quality)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_PARACABLES_BO.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_PARACABLES_BO")
