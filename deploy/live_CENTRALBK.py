...
Win Rate: 58.60% -> Target 65%+ (v8 LOWWR: full multi-filter upgrade from MA_ENVELOPE)
Position: ₹7000 | Stop Loss: 0.6% | Target: 4.0x ATR | Daily Loss Cap: 0.3%
Enhanced: 2026-03-23 - v8 LOWWR: replaced MA_ENVELOPE with multi-filter VWAP strategy
"""
...
def main():
    print(f"\n{'='*60}")
    print(f"Running: CENTRALBK.NS | Strategy: VWAP_RSI_MACD_VOL_BB_v8_LOWWR")
    print(f"{'='*60}")
