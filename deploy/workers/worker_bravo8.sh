#!/bin/bash
# Worker BRAVO-8: Enhance BHEL VWAP strategy with multi-timeframe
cd /home/node/workspace/trade-project

SCRIPT="deploy/live_BHEL.py"
...
python3 -m py_compile "$SCRIPT" && echo "BRAVO-8: BHEL OK" || echo "BRAVO-8: FAILED"
cd /home/node/workspace/trade-project
git add deploy/live_BHEL.py && git commit -m "BRAVO-8: Enhance BHEL with multi-timeframe VWAP" 2>&1 || echo "No changes"
echo "BRAVO-8 COMPLETE"