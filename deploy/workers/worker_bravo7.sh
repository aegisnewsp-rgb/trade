#!/bin/bash
# Worker BRAVO-7: Enhance BHARATWIRE VWAP strategy
cd /home/node/workspace/trade-project

SCRIPT="deploy/live_BHARATWIRE.py"
...
python3 -m py_compile "$SCRIPT" && echo "BRAVO-7: BHARATWIRE OK" || echo "BRAVO-7: FAILED"
cd /home/node/workspace/trade-project
git add deploy/live_BHARATWIRE.py && git commit -m "BRAVO-7: Enhance BHARATWIRE with tightened stop loss" 2>&1 || echo "No changes"
echo "BRAVO-7 COMPLETE"