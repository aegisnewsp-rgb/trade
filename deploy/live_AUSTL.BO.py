...
logging.basicConfig(level=logging.INFO, format="%(asctime)s [%(levelname)s] %(message)s",
    handlers=[logging.FileHandler(LOG_DIR / "live_AUSTL.BO.log"), logging.StreamHandler(sys.stdout)])
log = logging.getLogger("live_AUSTL.BO")

SYMBOL = "AUSTL.BO"; STRATEGY = "VWAP"; POSITION = 7000; STOP_LOSS_PCT = 0.008; TARGET_MULT = 4.0; DAILY_LOSS_CAP = 0.003
