...
Win Rate: PRAKASHSTL.BO (low base) -> Target 55%+ (v8 multi-filter upgrade)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_PRAKASHSTL_BO.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_PRAKASHSTL_BO")

# ── Config ────────────────────────────────────────────────────────────────────
SYMBOL         = "PRAKASHSTL.BO"
STRATEGY       = "VWAP_RSI_MACD_VOL_BB_v8_LOWWR"  # PRAKASHSTL.BO
POSITION       = 7000
