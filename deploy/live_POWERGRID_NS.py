#!/usr/bin/env python3
"""
Live Trading Script - POWERGRID.NS
Strategy: VWAP + RSI + MACD + Volume + Trend + Bollinger Band (Enhanced v8)
Win Rate: POWERGRID_NS (low base) -> Target 62%+ (v8 multi-filter upgrade)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_POWERGRID_NS.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_POWERGRID_NS")
