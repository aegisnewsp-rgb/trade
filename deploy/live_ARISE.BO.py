...
Win Rate: ARISE.BO (low base) -> Target 55%+ (v8 multi-filter upgrade)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_ARISE_BO.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_ARISE_BO")

# ── Config ────────────────────────────────────────────────────────────────────
SYMBOL         = "ARISE.BO"
STRATEGY       = "VWAP_RSI_MACD_VOL_BB_v8_LOWWR"  # ARISE.BO
POSITION       = 7000
