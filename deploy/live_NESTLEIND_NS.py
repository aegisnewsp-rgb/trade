#!/usr/bin/env python3
"""
Live Trading Script - NESTLEIND.NS
Strategy: VWAP + RSI + MACD + Volume + Trend + Bollinger Band (Enhanced v8)
Win Rate: NESTLEIND_NS (low base) -> Target 62%+ (v8 multi-filter upgrade)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_NESTLEIND_NS.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_NESTLEIND_NS")
