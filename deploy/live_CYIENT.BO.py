...
Enhanced: 2026-03-23 - v9b MEAN_REVERSION: 0% WR v9 (0 trades) - vol_mult 2.0→1.3 to unlock signals on thin small-cap
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_CYIENT_BO.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_CYIENT_BO")

# ── Config ────────────────────────────────────────────────────────────────────
SYMBOL         = "CYIENT.BO"
STRATEGY = "MEAN_REVERSION_RSI_V9"  # CYIENT.BO
POSITION       = 7000
