#!/usr/bin/env python3
"""
ENHANCED TRADING SCRIPT - CYIENT.BO
===================================
Strategy: MEAN_REVERSION with RSI + Volume Confirmation
Previous: 0% WR (12 trades) - RE-ENHANCED with MEAN_REVERSION mode
- RSI Oversold (<35) for BUY, RSI Overbought (>65) for SELL
- Volume confirmation: >1.2x 20-day avg volume
...
SYMBOL         = "CYIENT.BO"
EXCHANGE       = "BSE"
STRATEGY       = "MEAN_REVERSION"  # Changed from VWAP - 0% WR script
POSITION       = 7000
