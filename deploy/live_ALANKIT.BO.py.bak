...
Win Rate: ALANKIT.BO (low base) -> Target 55%+ (v8 multi-filter upgrade)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_ALANKIT_BO.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_ALANKIT_BO")

# ── Config ────────────────────────────────────────────────────────────────────
SYMBOL         = "ALANKIT.BO"
STRATEGY       = "VWAP_RSI_MACD_VOL_BB_v8_LOWWR"  # ALANKIT.BO
POSITION       = 7000
