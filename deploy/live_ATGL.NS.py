#!/usr/bin/env python3
"""
ENHANCED TRADING SCRIPT - live_ATGL.NS
===================================
Strategy: VWAP
Win Rate: low -> Target 55%+ (v8 multi-filter failed, v9 MEAN_REVERSION)
Enhanced: 2026-03-23 - v9 MEAN_REVERSION
 with Multi-Filter Confirmation
...
Strategy: VWAP
Win Rate: low -> Target 50%+ (v9c MEAN_REVERSION - RSI 40/60 crossover + vol 2x)
Position: ₹5000 | Stop Loss: 0.6% | Target: 4.0x | Daily Loss Cap: 0.25%
Enhanced: 2026-03-23 - v9c: RSI crossover + tighter params
"""
...
PARAMS         = {"vwap_period": 14, "atr_multiplier": 0.5}
...
# Entry window (energy stocks have specific volume patterns)
...
def place_groww_order(symbol, signal, quantity, price):
    ...
    if signal == "BUY":
        ...
        stop_loss = price - (atr * 2.0)  # 2x ATR stop - wider for high-vol stock
