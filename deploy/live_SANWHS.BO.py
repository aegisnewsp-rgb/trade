...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_SANWHS.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_SANWHS")
...
def log_signal(signal, price, atr):
    log_file = LOG_DIR / "signals_SANWHS.json"
    entries = []
    if log_file.exists():
...
def daily_loss_limit_hit():
    cap_file = LOG_DIR / "daily_pnl_SANWHS.json"
