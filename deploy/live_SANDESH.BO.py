#!/usr/bin/env python3
"""
Live Trading Script - SANDESH.BO
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_SANDESH.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_SANDESH")
...
def log_signal(signal, price, atr):
    log_file = LOG_DIR / "signals_SANDESH.json"
    entries = []
    if log_file.exists():
...
def daily_loss_limit_hit():
    cap_file = LOG_DIR / "daily_pnl_SANDESH.json"
