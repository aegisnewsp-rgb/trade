...
def get_signal():
    """Generate trading signal for BANKINDIA. Returns (signal, price, atr)"""
    try:
        import yfinance as yf
        ticker = yf.Ticker("BANKINDIA.NS")
...
def main():
    ...
    if sig:
        print(f"SIGNAL: {sig} BANKINDIA @ Rs{price:.2f} ATR:{atr:.2f}")
    else:
        print(f"BANKINDIA: No signal")
