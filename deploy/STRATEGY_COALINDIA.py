...
ENTRY_RSI_MAX  = 70    # BUY on RSI < 70 (momentum not exhausted)
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"COALINDIA.NS  |  {ist.strftime('%H:%M IST')}  |  VWAP Momentum BUY")
    print(f"{'='*60}")
