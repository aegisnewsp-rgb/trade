#!/usr/bin/env python3
"""
Live Trading Script - TATAELXSI.NS
...
Note: Near 52W low (5.3% above); elevated volume (2.34x avg) on Mar 20 — breakout watch.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_TATAELXSI.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_TATAELXSI")
...
def log_signal(signal: str, price: float, atr: float, rsi: float):
    log_file = LOG_DIR / "signals_TATAELXSI.json"
...
def daily_loss_limit_hit() -> bool:
    cap_file = LOG_DIR / "daily_pnl_TATAELXSI.json"
