#!/usr/bin/env python3
"""
Live Trading Script - ABFRL.BO.py
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "live_ABFRL_BO.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("live_ABFRL_BO")

# ── Config ────────────────────────────────────────────────────────────────────
SYMBOL         = "ABFRL.BO"
STRATEGY = "MEAN_REVERSION_RSI_V9"  # ABFRL.py
TARGET_1_MULT = 1.5
TARGET_2_MULT = 3.0
TARGET_3_MULT = 5.0
STOP_LOSS_PCT  = 0.006
