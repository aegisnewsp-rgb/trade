#!/usr/bin/env python3
"""Live Trading Script - DATAMPULSE
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / "DATAMPULSE.log"),
        logging.StreamHandler(sys.stdout),
    ],
)
log = logging.getLogger("DATAMPULSE")
...
def log_signal(signal: str, price: float, atr: float):
    log_file = LOG_DIR / "signals_DATAMPULSE.json"
...
def daily_loss_limit_hit() -> bool:
    cap_file = LOG_DIR / "daily_pnl_DATAMPULSE.json"
